...
export default function TopEarnData({ filteredData, isLoading }: { filteredData: EarnSchema, isLoading: boolean }) {
    return (
        <div className='flex flex-col lg:flex-row w-full gap-5'>
            <SkeletonWrapper isLoading={isLoading}>
                <Card className='p-5 w-full lg:w-4/6'>
