...
import { OracleImageCustom } from '../oracle/OracleImageCustom';

interface SelectOracleImageProps {
...
const SelectOracleImage: React.FC<SelectOracleImageProps> = ({
    data,
    value = '',
    onChange,
    isLoading
...
export default SelectOracleImage;