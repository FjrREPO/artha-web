...
export function DataTable<TData extends EarnData, TValue>({
  columns,
  data,
  handleRefresh,
  isLoading,
    ...
    <div className="z-10">
      <div className="flex flex-wrap items-end justify-between gap-2 mb-4 z-10">
        <div className="flex flex-wrap justify-between w-full items-center gap-2">
          <Label className="text-2xl font-normal">Top Earn</Label>
          <div className="flex gap-2">
            <Button onClick={handleRefresh} variant={"default"}>Refresh Table</Button>
            <Button variant={"default"} onClick={() => window.location.href = '/earn'}>See All</Button>
          </div>
        </div>
      </div>
